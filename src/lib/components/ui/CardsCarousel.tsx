...
const CardComponent = () => {
  return (
    <div className=" relative m-auto h-48 w-80 rounded-xl bg-gradient-to-r from-purple-500 to-pink-400 text-white shadow-2xl transition-transform sm:h-56 sm:w-96 sm:hover:scale-110">
  ...
  return (
    <div className="w-full overflow-hidden">
      <motion.div
        ...
        className="flex will-change-transform cursor-grab active:cursor-grabbing bg-transparent cursor-grabbing"
      >
        {items.slice(0, 8)?.map((itemData, index) => {
          return (
            <motion.div className="min-w-[20rem] h-fit mr-1  bg-transparent " key={index}>
